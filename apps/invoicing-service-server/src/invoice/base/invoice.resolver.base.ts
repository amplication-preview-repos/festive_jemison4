...
export class InvoiceResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [InvoiceItem], { name: "invoiceItems" })
  @nestAccessControl.UseRoles({
  ...
  async findInvoiceItems(
    ...
    const results = await this.service.findInvoiceItems(parent.id, args);
  ...
  async getUser(@graphql.Parent() parent: Invoice): Promise<User | null> {
